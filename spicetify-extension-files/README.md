...
For a Trackspot server running on another machine, you will also need to set up HTTPS. The readme on the Trackspot GitHub page has instructions covering this.
